  ...
  return (
    <>
      <div className="w-[100vw] h-auto flex flex-col justify-start items-start about ">
          ...
          <div className=" w-full h-full flex items-center justify-center flex-wrap">
            {chooseSuvarna?.map((d, index) => {
              return (
                <div
                  key={index}
                  className="choose_card w-[312px] 
                  h-[360px] flex justify-center items-center hover:scale-110 lg:mx-[24px] mx-[12px] md:my-2 my-[12px]"
                  onMouseEnter={() => {
                    setIsMouseOver(true);
                    setId(d.id);
                  }}
                ...
                >
                  ...
                  <div className="md:text-[16px] text-[14px] text-center">
                    {d.description}
                  </div>
                </div>
              );
        ...
        <div className="w-full flex justify-center items-center mt-[46px] mb-[120px] relative">
        ...
        <div className="w-full py-[84px] flex justify-center items-center ">
