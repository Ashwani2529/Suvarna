  ...
  return (
    <div className="relative w-full h-[3504px] bg-white">
      <div className="inline-flex flex-col items-center gap-[120px] absolute top-[97px] left-0 w-full">
        <ProductsPre
          head={"Electronic Medical Record"}
          paragraph={
            "Enable doctors and care givers for a better connected & coordinated patient care, with Suvarna EMR"
          }
        />
        <ProductsProRis
          cardHead={"For Clinicians/ Doctors"}
          cardHead1={cardHead1}
          cardHead2={cardHead2}
          h={642}
          t={253}
