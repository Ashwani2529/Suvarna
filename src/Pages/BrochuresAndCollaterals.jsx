...
export const BrochuresAndCollateral = () => {
  ...
  return (
    <div className='BrochuresAndCollateral h-auto flex-col justify-start items-center '>
      ...
      <div className='h-auto md:h-[700px] w-screen flex flex-col justify-start items-center md:my-32 my-[60px]'>
        <div className='lg:w-10/12 md:w-11/12 w-full flex flex-wrap justify-center items-center py-6 md:py-[60px]'>
          {files.map((d, index) => {
            return (
              <div
                key={index}
                className='card mb-8 mx-4 md:mx-2 lg:mx-4 xl:mx-6 w-full md:w-1/2 lg:w-1/3 xl:w-1/4'
                onMouseOver={() => {
                  setIsMouseOver(true);
                  setCardId(d.id);
                }}
              ...
              >
                ...
                <div className='card_title mt-[16px]'>{d.title}</div>
                <div className='card_regular_text  mb-[16px]'>
                  {d.total_pages} Pages
                </div>
