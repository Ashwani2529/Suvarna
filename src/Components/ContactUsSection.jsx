...
export const ContactUsSection = () => {
  return (
    <div className="w-screen h-screen flex justify-center items-center" id="contactus">
      <div className="lg:w-10/12 md:w-11/12 w-full h-full flex justify-center items-center ">
      <div className="w-1/2 h-full md:flex hidden justify-start items-start overflow-hidden">
        <img
      ...
      <form className="md:w-1/2 w-11/12 h-full flex flex-col justify-center items-center px-16">
        <div className="w-full h-full flex flex-col justify-between items-start">
          <div className="w-full h-36 flex flex-col justify-start items-start ">
            <p className="text-[28px] font-medium">Got queries? We’d love to help.</p>
