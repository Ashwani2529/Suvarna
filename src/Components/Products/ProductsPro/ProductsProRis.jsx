...
export const ProductsProRis = ({cardHead,cardHead1,cardHead2,h,t}) => {
  ...
  return (
    <>
    <div className="relative w-full h-[1950px] bg-white">
    <div className="relative h-[1950px] w-[99%]">
      <div style={{height:`${h}px`,top:`${t}px`}} className="absolute w-full left-px object-cover">
      <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="1366" viewBox="0 0 100% 1366" fill="none">
  <path d="M362.561 267.555C348.598 266.615 334.526 265.594 320.934 263.939C251.965 255.542 172.637 214.356 104 225.138L0 243.831V1347.55L654.89 1437.47C689.999 1442.29 725.758 1437.7 758.508 1424.16L1137.24 1267.58C1184.6 1248.01 1237.66 1247.35 1285.49 1265.76L1303.58 1272.72C1369.09 1297.93 100% 1249.58 100% 1179.4V357.686V0.40332L1378.37 82.0259C1336.3 138.193 1266.65 166.534 1197.32 155.698C1146.03 147.683 1093.7 161.046 1052.53 192.67L1023.22 215.19C968.09 257.536 894.932 268.223 829.998 243.415L721.761 202.062C673.472 183.613 619.916 184.578 572.323 204.754L461.534 251.719C430.403 264.916 396.298 269.827 362.561 267.555Z" fill="url(#paint0_linear_2016_2904)" fill-opacity="0.4"/>
  <defs>
