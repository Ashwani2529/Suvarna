...
export const ProductsProSli = ({cardHead,cardHead1,cardHead2,cardHead3}) => {
  let path1 = "../assets/Product_Module_Image.svg";
  let path2 = "../assets/Product_Module_Image1.svg";
  return (
    <>
    <div className="relative w-full h-[2650px] bg-white">
  ...
  <div className="top-[40px] my-5 inline-flex flex-col items-center relative flex-[0_0_auto]">
