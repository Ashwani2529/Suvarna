...
export const ProductsProHIMS = ({cardHead,cardHead1,cardHead2,cardHead3,cardHead4,cardHead5,cardHead6}) => {
  let path1 = "../assets/Product_Module_Image.svg";
  let path2 = "../assets/Product_Module_Image1.svg";
  return (
    <>
    <div className="relative w-full h-[4350px]">
    <div className="relative w-[99%]">
      <img src={bgImg} alt="" style={{position:'absolute',left:'9px',top:'1200px',height:"2900px",width:'100vw'}}/>
      ...
      <div className="inline-flex flex-col items-start absolute top-[2172px] left-16">
        <ProductModuleCard head={cardHead3} path={path2}
          className="!flex-[0_0_auto]"
          icon={<ProductModuleImage className="!absolute !w-[304px] !h-[304px] !top-[88px] !left-0" />}
        />
      </div>
      <div className="inline-flex flex-col items-start absolute top-[2724px] right-16">
        <ProductModuleCard head={cardHead4} path={path1}
          className="!flex-[0_0_auto]"
          icon={<ProductModuleImage className="!absolute !w-[304px] !h-[304px] !top-[88px] !left-0" />}
        />
      </div>
      <div className="inline-flex flex-col items-start absolute top-[3276px] left-16">
        <ProductModuleCard head={cardHead5} path={path2}
          className="!flex-[0_0_auto]"
          icon={<ProductModuleImage className="!absolute !w-[304px] !h-[304px] !top-[88px] !left-0" />}
        />
      </div>
      <div className="inline-flex flex-col items-start absolute top-[3828px] right-16">
  ...
  <div className="my-5 inline-flex flex-col items-center relative flex-[0_0_auto]">
